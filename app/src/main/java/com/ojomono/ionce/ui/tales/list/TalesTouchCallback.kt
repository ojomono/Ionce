...
// TODO for drag n' drop feature
//class TalesTouchCallback(private val adapter: TalesListAdapter) : ItemTouchHelper.Callback() {
//
...
//        val dragFlags =
//            if (viewHolder.itemViewType == BaseListAdapter.ITEM_VIEW_TYPE_DATA)
